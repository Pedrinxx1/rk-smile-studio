...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Decorative orbs */}
      <div className="absolute top-32 right-20 w-80 h-80 rounded-full bg-gold-glow/10 blur-[100px] animate-pulse-soft" />
      <div className="absolute bottom-32 left-10 w-[500px] h-[500px] rounded-full bg-gold/5 blur-[120px] animate-pulse-soft" style={{ animationDelay: "2s" }} />
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-16 py-32">
        <div className="max-w-2xl lg:max-w-3xl">
          <motion.div
            ...
            className="mb-8"
          >
            <span className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full border border-primary/25 bg-primary/5 backdrop-blur-sm">
          ...
          >
            <span className="text-foreground block">Seu sorriso</span>
            <span className="text-foreground block">e sua estética</span>
          ...
          >
            ...
            <a
              href="#servicos"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-foreground/15 text-foreground/70 text-base font-medium hover:bg-foreground/5 hover:border-foreground/25 transition-all duration-300"
            >
              Nossos serviços
            </a>
          </motion.div>
      ...
      <motion.a
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 text-foreground/30 hover:text-foreground/60 transition-colors cursor-pointer"
      >
